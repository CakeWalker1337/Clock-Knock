...
public class WorklogModule{
    ...
    @Provides
    @WorklogScope
    WorklogRepository provideWorklogRepository(@NonNull ResourceManager aResourceManager, @NonNull RestApi aRestApi){
        return new WorklogRepositoryImpl(aResourceManager, aRestApi);
    }
